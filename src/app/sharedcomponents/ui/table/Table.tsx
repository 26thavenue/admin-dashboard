...
import RenderComponents from './TableComponents/RenderComponents';
...
const Table: FC<TableProps> = ({
  ...
  useEffect(() => {
    if (tableIndex) {
      getSelected && getSelected(selectedRows, tableIndex);
    } else {
                          ...
                          {sortHeader && (
                            <>
                              {sortColumn === th.accessor && (
                                <span className="ml-1">
                                  {sortDirection === 'asc' ? (
                                    <ArrowUpIcon className="text-primary-600 h-3 w-3" />
                                  ) : (
                                    <ArrowDownIcon className="text-primary-600 h-3 w-3" />
                                  )}
                                </span>
                              )}
                              {sortColumn !== th.accessor && (
        ...
        <div className="relative mt-5 flex w-full">
          <ReactPaginate
            nextLabel={
              <div
                className={classNames(
                  'text-primary-700 flex items-center gap-2',
                  nextprevBtn,
                  {
              ...
              >
                ...
                <ArrowRightIcon className="text-primary-700 h-5 w-5 " />
              </div>
            }
            previousLabel={
              <div
              ...
              >
                <ArrowLeftIcon className=" text-primary-700 h-5 w-5 lg:snap-start" />
