  ...
  return (
    <div className="flex flex-row gap-1">
      <div className="basis-1/12">
        <TickSquare className="text-success-700 h-5 w-5" />
      </div>
      <div className="basis-10/12">
        <h5 className="break-words text-sm font-medium text-white">{event}</h5>
        <p className="break-words text-xs text-gray-300">{message}</p>
      </div>
      <div className="basis-1/12">
        <CloseCircle
